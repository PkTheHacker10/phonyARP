<img src="img/phonyarp.png" width=700px padding-left=20px></img>

# PhonyARP 

PhonyARP is a python tool is used for ARP spoofing or ARP poisoning which is developed by [**PkTheHacker10**](https://github.com/PkTheHacker10) .  
...
**NOTE** : This is a tool which will use network interface to send Poisoned ARP packets in the network so it **need superuser permission** to do this.
...
### Step 3:
Use this command to install this tool in system wide to access this tool in cli .
...
I used Vm to make this secured network environment.

	Gateway  		ip : 192.168.1.1
	Target   (windows 7) 	ip : 192.168.1.8
...
Note :-
- You and the victim should be in the same subnet.
- Should enable Ip forward to avoid intruption in victim network.
